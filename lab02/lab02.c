...
{ 
  ...
  //testing function from Q2
  printf("\nCapitalize first column test:\n");
  apply_by_row(capitalize_first_col, data, data_rows, data_cols);
  
  //testing function from Q4
  printf("\nApply by column test:\n");
             ...
             int rows, int cols)
{
  ...
  // If we flip i and j, the logic is the same but accessing by col now.
